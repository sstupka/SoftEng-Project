...
public class TwoObjectsMovingApartActivity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        res = getResources();
        setContentView(R.layout.twoobjectsmovingapartactivity);
    ...
    private void updateAll() {
        ...
        if(solveFor.equals("d (Total distance)") && t4.length()>0 && t8.length()>0 && t10.length()>0) {
        ...
        if(solveFor.equals("v1 (First object velocity)") && t2.length()>0 && t8.length()>0 && t10.length()>0) {
        ...
        if(solveFor.equals("t (Total elapsed time)") && t2.length()>0 && t4.length()>0 && t10.length()>0) {
        ...
        if(solveFor.equals("v2 (Second object velocity)") && t2.length()>0 && t4.length()>0 && t8.length()>0) {
