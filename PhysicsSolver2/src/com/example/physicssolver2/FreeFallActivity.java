...
public class FreeFallActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        res = getResources();
        setContentView(R.layout.freefallactivity);
    ...
    private void updateAll() {
        ...
        if(solveFor.equals("h (Height)") && t4.length()>0 && t8.length()>0 && t12.length()>0 && t14.length()>0) {
            ...
            if(units11.equals("s"))  ;
            if(units11.equals("min")) n2/=(60);
            if(units11.equals("hr")) n2/=(60*60);
            if(units11.equals("day")) n2/=(60*60*24);
            if(units11.equals("yr")) n2/=(60*60*24*365);
        ...
        if(solveFor.equals("vf (Final velocity)") && t2.length()>0 && t4.length()>0 && t12.length()>0 && t14.length()>0) {
            ...
            if(units11.equals("s"))  ;
            if(units11.equals("min")) n_*=(60);
            if(units11.equals("hr")) n_*=(60*60);
            if(units11.equals("day")) n_*=(60*60*24);
            if(units11.equals("yr")) n_*=(60*60*24*365);
        ...
        if(solveFor.equals("g (Acceleration due to gravity)") && t2.length()>0 && t4.length()>0 && t8.length()>0 && t12.length()>0) {
