...
public class ConservationOfMomentumActivity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        res = getResources();
        setContentView(R.layout.conservationofmomentumactivity);
    ...
    private void updateAll() {
        ...
        if(solveFor.equals("p1 (Initial momentum)") && t4.length()>0 && t6.length()>0 && t8.length()>0) {
            ...
            if(units7.equals("nN")) n2*=Math.pow(10,-9);
            if(units7.equals("μN")) n2*=Math.pow(10,-6);
            if(units7.equals("mN")) n2*=Math.pow(10,-3);
            if(units7.equals("cN")) n2*=Math.pow(10,-2);
            if(units7.equals("dN")) n2*=Math.pow(10,-1);
            if(units7.equals("N"))  ;
            if(units7.equals("kN")) n2*=Math.pow(10,3);
            if(units7.equals("MN")) n2*=Math.pow(10,6);
            if(units7.equals("GN")) n2*=Math.pow(10,9);
            ...
            if(units9.equals("nN")) n3*=Math.pow(10,-9);
            if(units9.equals("μN")) n3*=Math.pow(10,-6);
            if(units9.equals("mN")) n3*=Math.pow(10,-3);
            if(units9.equals("cN")) n3*=Math.pow(10,-2);
            if(units9.equals("dN")) n3*=Math.pow(10,-1);
            if(units9.equals("N"))  ;
            if(units9.equals("kN")) n3*=Math.pow(10,3);
            if(units9.equals("MN")) n3*=Math.pow(10,6);
            if(units9.equals("GN")) n3*=Math.pow(10,9);
        ...
        if(solveFor.equals("p2 (Initial momentum)") && t2.length()>0 && t6.length()>0 && t8.length()>0) {
        ...
        if(solveFor.equals("p1f (Initial momentum)") && t2.length()>0 && t4.length()>0 && t8.length()>0) {
            ...
            if(units7.equals("nN")) n_/=Math.pow(10,-9);
            if(units7.equals("μN")) n_/=Math.pow(10,-6);
            if(units7.equals("mN")) n_/=Math.pow(10,-3);
            if(units7.equals("cN")) n_/=Math.pow(10,-2);
            if(units7.equals("dN")) n_/=Math.pow(10,-1);
            if(units7.equals("N"))  ;
            if(units7.equals("kN")) n_/=Math.pow(10,3);
            if(units7.equals("MN")) n_/=Math.pow(10,6);
            if(units7.equals("GN")) n_/=Math.pow(10,9);

            t6.setText(String.format("%.2e",n_));
        }
        if(solveFor.equals("p2f (Initial momentum)") && t2.length()>0 && t4.length()>0 && t6.length()>0) {
            ...
            if(units9.equals("nN")) n_/=Math.pow(10,-9);
            if(units9.equals("μN")) n_/=Math.pow(10,-6);
            if(units9.equals("mN")) n_/=Math.pow(10,-3);
            if(units9.equals("cN")) n_/=Math.pow(10,-2);
            if(units9.equals("dN")) n_/=Math.pow(10,-1);
            if(units9.equals("N"))  ;
            if(units9.equals("kN")) n_/=Math.pow(10,3);
            if(units9.equals("MN")) n_/=Math.pow(10,6);
            if(units9.equals("GN")) n_/=Math.pow(10,9);
