...
public class ConservationOfEnergyActivity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        res = getResources();
        setContentView(R.layout.conservationofenergyactivity);
    ...
    private void updateAll() {
        ...
        if(solveFor.equals("g (Acceleration due to gravity)") && t6.length()>0 && t8.length()>0 && t10.length()>0 && t14.length()>0) {
        ...
        if(solveFor.equals("h0 (Initial height)") && t2.length()>0 && t8.length()>0 && t10.length()>0 && t14.length()>0) {
        ...
        if(solveFor.equals("hf (Final height)") && t2.length()>0 && t6.length()>0 && t10.length()>0 && t14.length()>0) {
        ...
        if(solveFor.equals("v0 (Initial velocity)") && t2.length()>0 && t6.length()>0 && t8.length()>0 && t14.length()>0) {
        ...
        if(solveFor.equals("vf (Final velocity)") && t2.length()>0 && t6.length()>0 && t8.length()>0 && t10.length()>0) {
